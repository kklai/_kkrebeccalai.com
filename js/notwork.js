...
function fillPage() {
	...
	for (var i = 3; i < content.length; i++) {
		...
		$('#fun .row:nth-child(' + row + ')').append('<div class="span4"><a href="' + content[i].link + '" target="_blank"><h2>' + content[i].title + '</h2></a><a href="' + content[i].link + '" target="_blank"><img src="' + content[i].imglink + '"></a><p>' + content[i].description + '</p></div>');
	}
	footer();
}
